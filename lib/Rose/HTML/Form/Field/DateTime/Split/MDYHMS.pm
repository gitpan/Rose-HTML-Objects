...
This class inherits (indirectly) from both C<Rose::HTML::Form::Field::DateTime>
...
C<validate()> methods to be inherited from C<Rose::HTML::Form::Field::DateTime>,
...
C<Rose::HTML::Form::Field::DateTime::Split::MonthDayYear> field, and the time
portion is handled by a
C<Rose::HTML::Form::Field::Time::Split::HourMinuteSecond> field.
